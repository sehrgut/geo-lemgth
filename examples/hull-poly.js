...
console.log("## Convex Hull Diameter / Polygon Area");
turf.featureEach(states, x => lemgth(x, lemgth.Metrics.HULL_DIAMETER_POLY_AREA));
...
turf.featureEach(states, x => console.log(fmt("%s: %d (%dkm, %dkm2)",
	...
	roundTo(convert(x.properties.AR_POLYAREA).from('m2').to('km2'), 0))));